...
class BankAccount:
    ...
    def deposit(self, amount):
        amount = float(input('Какую сумму вы хотите положить на сче?: '))
        self.balance += amount
        print(f'Вы положили на счет: {amount}')
    def withdraw(self, amount):
        self.amount = amount
        amount = float(input('Какую сумму денег вы хотите снять со счета?: '))
...
# Кирилл прошу прощения тут меня вызвали на работу
